...
//                        new ChatFragment()).commit();
                intent = new Intent(NotificationsActivity.this, ChangeScheduleActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_profile:
                ...
                break;
            case R.id.nav_exams:
                intent = new Intent(NotificationsActivity.this, ExamsActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_notes:
                intent = new Intent(NotificationsActivity.this, NotesActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_share:
